...
export default function MobileNav({ userType = 'client', consultantType = null }) {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 flex border-t border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 md:hidden">
            {items.map((item) => (
                <NavLink
                    key={item.path}
                    to={item.path}
